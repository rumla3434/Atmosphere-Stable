# 大气层1.10.2整合包系统稳定版（更新时间：2026.01.15）

大气层1.10.2最高支持NX-21.2.0系统。如果你一直使用我发布的包，以后的更新中没有特别的提醒，都是直接覆盖就完成大气层文件的升级。

2026.01.15更新atmosphere-1.10.2-master-eb34f9789，hekate_ctcaer_6.5.0_Nyx_1.9.0（hekate汉化补丁nyx.bin还要等大佬发布后替换）和sigpatch最高支持21.2.0系统。更新ultrahand的设置文件package.ini，默认一键关机，更新switchtime.nro--v0.1.6。新加系统21.0+降级后2162-0002出错免格式化恢复的DowngradeFixer.bin--v1.0.0。

（1）大气层1.10.2+hekate6.5.0+sigpatch都最高支持21.2.0系统，升级最新系统，所有分享出来的破解游戏资源只要本身没问题，硬件没问题，就能正常安装正常游玩，和大气层整合包系统稳定版没关系，因为稳定版大气层没有垃圾插件，不会影响游戏。
