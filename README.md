...
# 大气层1.9.3整合包系统稳定版（更新时间：2025.07.29）

大气层1.9.3最高支持NX-20.3.0系统。如果你一直使用我发布的包，以后的更新中没有特别的提醒，都是直接覆盖就完成大气层文件的升级。

2025.07.29系统更新20.3.0，原大气层1.9.2不支持，现下载外网提供的支持20.3.0系统1.9.3版本（替换stratosphere.romfs和package3两个文件），Hekate无需更新，更新sigpatch中的LOADER，原ES，FS，NIFM，NIM不变）适配20.3.0。真实系统没有误升级20.3.0的就不需要升级整合包，可以等大气层1.9.3正式版发布。
