# 大气层1.6.2整合包系统稳定版（更新时间：2024.01.05）

大气层1.6.2最高支持NX-17.0.1系统。

2024.01.05更新Z大佬的更新StatusMonitorOverlay v1.0.3a，更新DBI658，新加Hekate可加载的树莓派工具箱picofly_toolbox.bin，如果你一直使用我发布的包，以后的更新中没有特别的提醒，都是直接覆盖就完成大气层文件的升级。
