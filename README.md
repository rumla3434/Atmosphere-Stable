...
# 大气层1.9.3整合包系统稳定版（更新时间：2025.07.31）

大气层1.9.3最高支持NX-20.3.0系统。如果你一直使用我发布的包，以后的更新中没有特别的提醒，都是直接覆盖就完成大气层文件的升级。

2025.07.31由于250730版中Z大佬的Ultrahand-Overlay-2.0.0测试版有bug，所以换回Z大佬的Ultrahand-Overlay-1.9.5（替换ovlmenu.ovl和config/ultrahand/lang/语言包）。
