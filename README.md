# 大气层1.10.2整合包系统稳定版（更新时间：2026.01.18）

大气层1.10.2最高支持NX-21.2.0系统。如果你一直使用我发布的包，以后的更新中没有特别的提醒，都是直接覆盖就完成大气层文件的升级。

2026.01.18更新hekate_ctcaer_6.5.0_Nyx_1.9.0的汉化补丁nyx.bin，更新StatusMonitor.ovl-2026.01.18，更新DBI同文件夹下重命名DBI.nro.cn是汉化版DBI863。
