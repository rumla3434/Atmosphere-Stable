...
# 大气层1.9.5整合包系统稳定版（更新时间：2025.09.30）

大气层1.9.5最高支持NX-20.5.0系统。如果你一直使用我发布的包，以后的更新中没有特别的提醒，都是直接覆盖就完成大气层文件的升级。

2025.09.30系统更新20.5.0，大气层更新1.9.5正式版，更新sigpatch中的LOADER适配AMS1.9.5-de9b02007，更新JKSV.nro--09.13.2025。

（1）大气层1.9.5+hekate6.3.1+sigpatch都最高支持20.5.0系统，关于20.0.0+系统出现wifi联网待机耗电多的情况，见教程「分享」20.0.0+系统wifi联网待机耗电异常有效解决办法，可以有效解决，但是启动飞行模式待机还是最省电的。
