# 大气层1.9.0整合包测试版（更新时间：2025.05.07）
...
目前已知问题：国行系统不可以强刷20.0.0或以上，会变砖，要通过Tesla或Tencent-switcher-GUI转成全球系统才可以。全球系统升级20.0.1/20.0.0后不可降级，虚拟系统需要降级19.0.1也会报错，可以在进虚拟系统switch图标之前按住音量加减的官方恢复模式，进行保留数据系统初始化（快速）后才能进19.0.1。极限超频loader.kip不支持，需要转回普通超频插件才可以正常，教程「分享」普通超频sys-clk可以和极限超频EOS互相转换，，大气层自动识别fusee.bin未编译不支持sigpatch，暂时屏蔽fusee引导设置。
