# 大气层1.7.0整合包系统稳定版（更新时间：2024.06.09）

大气层1.7.0最高支持NX-18.0.1系统。

2024.06.09更新EdiZon.ovl和nro-2024.6.9，更新极限超频EOS1.2.7，但loader.kip依旧锁RAM最大1996。如果你一直使用我发布的包，以后的更新中没有特别的提醒，都是直接覆盖就完成大气层文件的升级。
