...
# 大气层1.9.4整合包系统稳定版（更新时间：2025.09.12）

大气层1.9.4最高支持NX-20.4.0系统。如果你一直使用我发布的包，以后的更新中没有特别的提醒，都是直接覆盖就完成大气层文件的升级。

2025.09.12更新DBI.nro--v810英文版（同文件夹下重命名DBI.nro.cn是汉化版DBI810，删除俄文版DBI.nro.ru文件），更新JKSV.nro--09.08.2025。新加大气层整合教程和更新一键清理大气层旧文件批处理。

（1）大气层1.9.4+hekate6.3.1+sigpatch都最高支持20.4.0系统，关于20.0.0+系统出现wifi联网待机耗电多的情况，见教程「分享」20.0.0+系统wifi联网待机耗电异常有效解决办法，可以有效解决，但是启动飞行模式待机还是最省电的。
