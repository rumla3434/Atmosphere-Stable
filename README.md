# 大气层1.10.0整合包系统稳定版（更新时间：2025.11.25）

大气层1.10.0最高支持NX-21.0.1系统。如果你一直使用我发布的包，以后的更新中没有特别的提醒，都是直接覆盖就完成大气层文件的升级。

2025.11.25更新NX-21.0.1系统，大气层1.10.0继续支持，所有插件软件也继续兼容，更新Checkpoint.nro--v3.10.2，DBI.nro--v844俄文版（同文件夹下重命名DBI.nro.cn是时大佬的汉化版DBI843，可手动重命名替换DBI.nro），Lockpick_RCM.bin小更新，删除tinfoil后补充tinwoo.nro--v1.0.28（和Awoo-Installer.nro类似）。
...
（1）大气层1.10.0+hekate6.4.1+sigpatch都最高支持21.0.1系统，升级最新系统，所有分享出来的破解游戏资源只要本身没问题，硬件没问题，就能正常安装正常游玩，和大气层整合包系统稳定版没关系，因为稳定版大气层没有垃圾插件，不会影响游戏。
